  ...
  if (pktCount <= MaxPkt)
    {
	  ...
	  if(tempPktCount[iCarID]!=pktCount){
		  ...
		  if(bf[iCarID][pktCount][0]<=bf[iCarID][pktCount][1] && bf[iCarID][pktCount][0]<=bf[iCarID][pktCount][2]){
		  ...
		  } else if(bf[iCarID][pktCount][1]<=bf[iCarID][pktCount][2]){
