...
void ReceivePacket (Ptr<Socket> socket)
{
	...
	while (packet = socket->RecvFrom(from))
    {
		...
		/*================= Local CBR does not need to be spread ==================================
  ...
  if (pktCount <= MaxPkt)
    {
	  ...
	  if(tempPktCount[iCarID]!=pktCount){
		  ...
		  if (dLocalCBR[iCarID][0]<=dLocalCBR[iCarID][1]&&dLocalCBR[iCarID][0]<=dLocalCBR[iCarID][2]){channelAssign[iCarID][pktCount]=1;}
		  else if (dLocalCBR[iCarID][1]<=dLocalCBR[iCarID][2]){channelAssign[iCarID][pktCount]=2;}
		  ...
		  if(channelAssign[iCarID][pktCount]==1){
		  ...
		  } else if(channelAssign[iCarID][pktCount]==2){
